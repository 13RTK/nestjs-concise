...
export class ArticlesController {
  ...
  @Post("me")
  createByCurrentUser(@Req() request: any, @Body() createArticleDto: CreateArticleDto) {
  ...
  @Get("me")
  findAllByCurrentUser(@Req() request: any, @Query() filterArticleDto: FilterArticleDto) {
    const authorId = Number(request.user.sub);
  ...
  updateByCurrentUser(
    ...
    return this.articlesService.updateByUser(authorId, articleId, updateArticleDto);
  }
